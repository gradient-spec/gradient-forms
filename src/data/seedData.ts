...
export const SEED_FORMS: Form[] = [
  ...
  },
  {
    ...
    title: 'Trial form 2 by Antigraviti',
    description: 'Comprehensive Multi-Question Type Evaluation Form created by Antigravity AI.',
    isPublished: true,
    status: 'published',
    createdAt: '2026-08-26T17:50:00Z',
    updatedAt: '2026-08-26T17:55:00Z',
    responseCount: 2,
    authorName: 'Alex Rivera',
    authorAvatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=150&q=80',
    workspaceId: 'ws-1',
    ...
    settings: {
      ...
      quizMode: false,
      releaseGradeImmediately: false,
      confirmationMessage: 'Thank you! Your response to Trial form 2 by Antigraviti has been recorded successfully.'
    },
    sections: [
      { id: 'sec-ag-1', title: 'Respondent Overview', description: 'Basic identity & email background.' },
      { id: 'sec-ag-2', title: 'Technical Assessment & Experience', description: 'Multiple question options evaluation.' }
    ],
    logicRules: [],
    versions: [],
    questions: [
      {
        ...
        type: 'short_answer',
        title: 'Full Name',
        placeholder: 'e.g. Antigravity Developer',
        required: true
      },
      {
        id: 'q-tf2-2',
        ...
        type: 'email',
        title: 'Email Address',
        placeholder: 'dev@antigravity.ai',
        required: true
      },
      {
        id: 'q-tf2-3',
        ...
        required: true,
        options: [
          { id: 'opt-tf2-react', label: 'React + TypeScript' },
          { id: 'opt-tf2-vue', label: 'Vue 3 + Vite' },
          { id: 'opt-tf2-svelte', label: 'SvelteKit' },
          { id: 'opt-tf2-next', label: 'Next.js App Router' }
        ]
      },
      {
        id: 'q-tf2-4',
        sectionId: 'sec-ag-2',
        type: 'checkboxes',
        title: 'Core Technical Competencies (Select up to 2)',
        required: true,
        maxSelections: 2,
        options: [
          { id: 'opt-tf2-3d', label: 'Three.js / WebGL 3D UI' },
          { id: 'opt-tf2-state', label: 'Advanced State & Context Management' },
          { id: 'opt-tf2-testing', label: 'Automated Vitest & Unit Testing' },
          { id: 'opt-tf2-api', label: 'REST API & Prisma Database' }
        ]
      },
      {
        id: 'q-tf2-5',
        sectionId: 'sec-ag-2',
        type: 'rating',
        title: 'Rate the Interface Design Quality (1 to 5 Stars)',
        required: true
      },
      {
        id: 'q-tf2-6',
        sectionId: 'sec-ag-2',
        type: 'scale',
        title: 'Likelihood of recommending Gradient Forms (1-10)',
        required: true
      },
      {
        id: 'q-tf2-7',
      ...
      },
      {
        ...
        sectionId: 'sec-ag-2',
        type: 'consent',
        title: 'I confirm that all evaluation responses submitted above are accurate.',
        required: true
      }
    ]
  }
